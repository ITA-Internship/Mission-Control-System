...
export function MissionModal({
  ...
  async function handleSubmit() {
    ...
    // Only send coordinates if the user actually entered them
    if (hasLat && hasLng) {
      payload.latitude = form.lat.trim();
      payload.longitude = form.lng.trim();
    }
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-xl mx-4 rounded-2xl flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-200"
        style={{
          background: "#0B0F14",
          border: "1px solid rgba(255,255,255,0.1)",
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 flex flex-col gap-4">
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                style={errors.commander ? { ...inputErrorStyle, cursor: "pointer" } : { ...inputStyle, cursor: "pointer" }}
            ...
            <div className="flex gap-2">
              <div className="flex-1">
                <input
                  type="text"
                  className={inputClass}
                  style={errors.lat ? inputErrorStyle : inputStyle}
              ...
              <div className="flex-1">
                <input
                  type="text"
                  className={inputClass}
                  style={errors.lng ? inputErrorStyle : inputStyle}
          ...
          <div>
            ...
            <input
              type="datetime-local"
              className={inputClass}
              style={errors.startedAt ? inputErrorStyle : inputStyle}
